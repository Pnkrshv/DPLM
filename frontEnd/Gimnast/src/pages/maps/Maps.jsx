            ...
            {isCreateMapOpen && (
                <>
                    ...
                    <div className="create-map-window">
                        ...
                        <form className="create-map-form" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="footer-map">
                                ...
                                <button className="map-submit" type="button" onClick={() => {
                ...
                <>
                    <div className="modal-map">
                        <div className="modal-map-nav">
                            ...
                            <div className="modal-map-settings" onClick={() => {
                        ...
                        <div className="modal-map-body">
                            <div className="modal-map-cities">
                                <p className="all-cities">
                                    {currentSavedCities.length === 0 ? <p>Нет выбранных городов</p> : <p><b>Всего: </b> {currentSavedCities.length}</p>}
                                </p>
