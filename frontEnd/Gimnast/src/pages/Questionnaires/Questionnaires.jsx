...
export default function Questionnaires() {
  ...
  const handleSaveQuestionnaire = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/questionnaire', questionnaireData);
  ...
  const exportToWord = async () => {
    ...
    try {
      ...
      const response = await axios.get(`/api/questionnaire/${currentQuestionnaire.id}/full`);
  ...
  const handleSaveQuestion = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `/api/questionnaire/${currentQuestionnaire.id}/questions`,
        questionPayload
      );
  ...
  const handleRemoveQuestion = async (questionId) => {
    ...
    try {
      await axios.delete(
        `/api/questionnaire/${currentQuestionnaire.id}/questions/${questionId}`
      );
    ...
    try {
      ...
      if (block && block.questions) {
        for (const question of block.questions) {
          await axios.delete(
            `/api/questionnaire/${currentQuestionnaire.id}/questions/${question.id}`
          );
        }
      }
              ...
              <button className="save-btn" onClick={async () => {
                ...
                if (hideRuleData.questionId) {
                  try {
                    ...
                    await axios.put(
                      `/api/question/${hideRuleData.questionId}/hide-rules`,
              ...
              <button className="save-btn" onClick={async () => {
                ...
                if (contradictionData.questionId) {
                  try {
                    ...
                    await axios.put(
                      `/api/question/${contradictionData.questionId}/contradiction-rules`,
