  ...
  return (
    <>
      <ul className="navBarCol">
        ...
        <li className="navBarRoute disabled">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="200"
            height="200"
        ...
        <NavLink to={"/manual-input"} style={{ textDecoration: 'none' }} className={getNavLinkClass}>
          <li className="manual-input">
            <svg
              fill="#ffffff"
              width="200"
              height="200"
